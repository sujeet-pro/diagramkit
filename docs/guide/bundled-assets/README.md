...
| Project skills                                              | `skills/diagramkit-{setup,auto,mermaid,excalidraw,draw-io,graphviz,review}/` | Source for the agent skills installed via `npx skills add sujeet-pro/diagramkit`.                                       |
