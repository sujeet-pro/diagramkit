...
Complete guide for creating elbow arrows with proper connections in Excalidraw JSON.
...
**Without all three, arrows will be curved, not 90-degree elbows.**
...
```
Source: x=100, y=200, width=160, height=80
Target: x=400, y=200, width=160, height=80

source_right = (100 + 160, 200 + 80/2) = (260, 240)
target_left = (400, 200 + 80/2) = (400, 240)
...
- Vertical arrow: `label.y = arrow.y + (total_height / 2)`, `label.x = arrow.x + 10`
- Horizontal arrow: `label.x = arrow.x + (total_width / 2)`, `label.y = arrow.y - 15`
...
## Complete Arrow Element

For reference, a complete arrow element with all required properties:
