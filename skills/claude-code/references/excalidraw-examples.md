...
Full JSON examples showing proper element structure for Excalidraw diagrams rendered by diagramkit.
...
Dashed rectangle with standalone label:
...
For a diagram with N labeled shapes and M arrows:

- Shape elements: N
- Text elements: N (one per labeled shape)
- Arrow elements: M
- Group rectangles: G (optional)
- Group labels: G (optional, standalone text)
- Title text: 0-1 (optional)
- Arrow labels: L (optional, standalone text)
- **Total elements**: 2N + M + 2G + title + L

Example: 8 services, 10 arrows, 2 groups, 1 title = 16 + 10 + 4 + 1 = 31 elements
