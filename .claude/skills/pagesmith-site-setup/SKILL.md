...
<!-- pagesmith-skill-mirror: canonical=.agents/skills/pagesmith-site-setup/SKILL.md -->

# pagesmith-site-setup

Follow [`.agents/skills/pagesmith-site-setup/SKILL.md`](../../../.agents/skills/pagesmith-site-setup/SKILL.md). Do not duplicate its content here.
