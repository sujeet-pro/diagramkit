...
<!-- pagesmith-skill-mirror: canonical=.agents/skills/pagesmith-site-customize-theme/SKILL.md -->

# pagesmith-site-customize-theme

Follow [`.agents/skills/pagesmith-site-customize-theme/SKILL.md`](../../../.agents/skills/pagesmith-site-customize-theme/SKILL.md). Do not duplicate its content here.
